/**
 * Script to add the second new working API key
 */
...
const NEW_KEY = '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';
...
async function main() {
  try {
    ...
    console.log('➕ Adding Second New API Key');
    console.log('='.repeat(70));
    console.log('');
