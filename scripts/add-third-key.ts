/**
 * Script to add the third new working API key
 */
...
const NEW_KEY = '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';
...
async function main() {
  try {
    ...
    console.log('➕ Adding Third New API Key');
    console.log('='.repeat(70));
    console.log('');
