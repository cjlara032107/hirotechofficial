/**
 * Direct script to add the new working API key
 * Uses environment variables or defaults from documentation
 */
...
if (!process.env.ENCRYPTION_KEY) {
  ...
  console.log('⚠️  Using default ENCRYPTION_KEY from documentation');
}
      ...
      const apiKey = await prisma.apiKey.create({
        data: {
          ...
          metadata: {
            ...
            addedBy: 'add-new-key-direct-script',
          },
        },
      });
